...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=SQLHomework;Integrated Security=True;Connect Timeout=60;Encrypt=True;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False;Command Timeout=30");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Address>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Address__3214EC072F9FE819");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Company__3214EC0701FA4BC1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC0771214754");

            entity.ToTable("Employee", tb => tb.HasTrigger("trg_Employee_Insert_CreateCompany"));
        ...
        modelBuilder.Entity<EmployeeInfo>(entity =>
        {
            ...
            entity.Property(e => e.City).HasMaxLength(20);
            entity.Property(e => e.CompanyName).HasMaxLength(20);
            entity.Property(e => e.EmployeeCompanyInfo).HasMaxLength(51);
            entity.Property(e => e.EmployeeFullAddress).HasMaxLength(173);
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Person__3214EC07CCB903E3");
